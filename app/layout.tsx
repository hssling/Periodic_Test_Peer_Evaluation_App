...
export const metadata: Metadata = {
  ...
  authors: [{ name: "Dr. Siddalingaiah H S", url: "mailto:hssling@yahoo.com" }],
  creator: "Dr. Siddalingaiah H S - Shridevi Institute of Medical Sciences",
  publisher: "Department of Community Medicine, SIMS Tumkur",
  formatDetection: {
    email: false,
    address: false,
    telephone: false,
