          ...
          <CardContent className="space-y-4">
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) => setSettings({ ...settings, evaluatorsPerSubmission: parseInt(e.target.value) })}
              />
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-muted-foreground">Accept submissions after deadline</p>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input
                  type="checkbox"
