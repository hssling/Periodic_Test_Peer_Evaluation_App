...
export default async function AdminDashboardPage() {
    ...
    const activeTests = tests.filter(t => getTestStatus(t.start_at, t.end_at, t.status) === 'active').length;
    const totalStudents = students?.length || 0;
    const pendingEvaluations = pendingAllocations?.length || 0;
    const submittedAttempts = recentAttempts.filter(a => a.status === 'submitted').length;
                                ...
                                recentTests.map((test) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <span
                                                className={`inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-xs font-medium ${status === 'active'
                                ...
                                recentAttempts.slice(0, 5).map((attempt) => (
                                    ...
                                    >
                                        ...
                                        <div className="text-right">
                                            <span
                                                className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-medium ${attempt.status === 'submitted'
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-sm text-muted-foreground mt-1">
                                        There are evaluations pending from peer reviewers. Consider sending reminders.
                                    </p>
                                </div>
